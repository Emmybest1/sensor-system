const types = {
  LOG_IN_STARTED: '@sensorsystem/session/LOG_IN_STARTED',
  LOG_IN_SUCCESS: '@sensorsystem/session/LOG_IN_SUCCESS',
  LOG_IN_FAILURE: '@sensorsystem/session/LOG_IN_FAILURE',
