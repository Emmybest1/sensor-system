...
import { SignUp, Login, Fallback, Histories, Home } from 'components/pages';
  ...
  <Router>
    <ErrorBoundary>
      <Switch>
        ...
        <ProtectedRoute exact path={Paths.history} component={Histories} pagePermissionNumber={PAGES_PERMISSIONS.HISTORY} />
